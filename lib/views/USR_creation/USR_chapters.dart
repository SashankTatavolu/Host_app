...
import 'package:lc_frontend/views/USR_creation/USR_chapter_list.dart';
...
class USRChaptersPage extends StatefulWidget {
  final int projectId;
  final VoidCallback onChapterAdded;

  const USRChaptersPage(
      {super.key, required this.projectId, required this.onChapterAdded});

  @override
  State<USRChaptersPage> createState() => _USRChaptersPageState();
}

class _USRChaptersPageState extends State<USRChaptersPage> {
